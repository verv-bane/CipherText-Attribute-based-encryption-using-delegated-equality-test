...
<!-- content begins -->
  <div id="content">
	...
	<br>	
	 <p><center><font size="5" color="white">View Attending Physician Requests </font></center></p><br/>			
       <style>
        th{
            color: #50aac3;
        }
...
try{ 
        ...
        PreparedStatement pst=con.prepareStatement("select * from request1 where owneremail = '"+user+"' ");
...
<%
	...
	while(rs.next()){
            %><tr>
                ...
                <td><a href="user_aprequests1.jsp?filename=<%=rs.getString("filename")%>&user=<%=rs.getString(1)%>&id=<%=rs.getInt("id")%>"><font color="#0d637d" size="3">Response</font></a> </td>
