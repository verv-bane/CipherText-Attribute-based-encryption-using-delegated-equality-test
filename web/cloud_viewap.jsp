...
<!-- content begins -->
  <div id="content">
   ...
   <p><center><font size="5" color="white"> View Attending Physician </font></center></p><br/>			
       <style>
        th{
            color: #50aac3;
        }
...
try{ 
        ...
        PreparedStatement pst=con.prepareStatement("select * from ap ");
...
<%
	...
	while(rs.next()){
            %><tr>
                ...
                <td><a href="cloud_apactivate.jsp?email=<%=rs.getString(3)%>"><font color="#0d637d" size="3">Activate</font></a> </td>
                <td><a href="cloud_apdeactivate.jsp?email=<%=rs.getString(3)%>"><font color="#0d637d" size="3">Deactivate</font></a> </td>
