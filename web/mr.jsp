...
<!-- content begins -->
  <div id="content">
    ...
    <div id="logo">
		...
		<div id="menu">
				...
				<div style="background:url(images/hr.gif); margin: 0 auto; height: 2px; margin-top: 5px;"></div>
                 ...
                 <br>               
                 <center><p><font size="5" color="white"> Medical Researcher Login </font></p><br/></center>
     
    <form action="mract.jsp" method="post">
    ...
    <br/>
    <center><a href="mrreg.jsp"><font color="white" style="font-size: 21px"> Sign Up </font></a> </center>  
