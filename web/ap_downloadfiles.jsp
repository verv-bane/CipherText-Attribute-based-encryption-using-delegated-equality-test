...
<!-- content begins -->
  <div id="content">
   ...
   <p><center><font size="5" color="white">Download Files </font></center></p><br/>			
       <style>
        th{
            color: #50aac3;
        }
...
try{ 
        ...
        PreparedStatement pst=con.prepareStatement("select * from request1 where user = '"+user+"' ");
...
<%
	...
	while(rs.next()){
            %><tr>
                ...
                <td><a href="ap_downloadfiles1.jsp?filename=<%=rs.getString("filename")%>&owner=<%=rs.getString(3)%>&id=<%=rs.getInt("id")%>"><font color="#0d637d" size="3">Download</font></a> </td>
