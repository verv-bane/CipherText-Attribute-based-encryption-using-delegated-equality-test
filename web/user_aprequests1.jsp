...
String skey = null;
 ...
 PreparedStatement pst1=con.prepareStatement("update request1 set height = '"+height+"',symptoms = '"+symptoms+"',disease = '"+disease+"',prate = '"+prate+"',location = '"+location+"',bloodpressure = '"+bloodpressure+"',weight = '"+weight+"',mobile = '"+mobile+"',doctor = '"+doctor+"',category = '"+category+"',data = '"+data+"',skey = '"+skey+"',status = 'Key Sent' where id = "+id+" ");
      pst1.executeUpdate();
...
response.sendRedirect("user_aprequests.jsp?msg=success");
