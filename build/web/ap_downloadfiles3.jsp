<%@page import="delegatedequalitytest.decryption"%>
...
String data = null;
      ...
      prate = request.getParameter("prate");
     ...
     String fcontent = new decryption().decrypt(data, skey);
   
    %>	
    <center><p><font size="5" color="white"> PHR Data </font></p><br/></center>
     
    <form action="ap_downloadfiles4.jsp" method="post">
   ...
   <tr>
    ...
    <td><input name="doctor" value="<%=doctor%>"/></td>
      <td height="43"><font color="white">Category</td>
      <td><input name="category" value="<%=category%>"/></td>
    </tr> 
    ...
    <td><textarea name="data" value="<%=fcontent%>"/><%=fcontent%></textarea></td>
