...
try{ 
        ...
        PreparedStatement pst=con.prepareStatement("select * from request where user = '"+user+"' ");
...
<%
	...
	while(rs.next()){
            %><tr>
                ...
                <td><a href="mr_downloadfiles1.jsp?filename=<%=rs.getString("filename")%>&owner=<%=rs.getString(3)%>&id=<%=rs.getInt("id")%>"><font color="#0d637d" size="3">Download</font></a> </td>
